  ...
  >
    <el-form label-width="70px" :model="editorForm" ref="editorForm">
      ...
      <el-form-item label="商品描述">
        <ProductWangEditorVue @onEditor="getEditor" :currentEditorData="editorData"></ProductWangEditorVue>
      </el-form-item>
    </el-form>
    <span slot="footer" class="dialog-footer">
      <el-button @click="dialogEditorVisible = false">取 消</el-button>
      <el-button type="primary" @click="editorProductHandel">确 定</el-button>
    </span>
  </el-dialog>
</template>
